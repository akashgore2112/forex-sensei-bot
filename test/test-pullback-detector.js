...
function testPullbackDetector() {
  console.log("=== Testing Pullback Detector (10-candle lookback) ===\n");
  ...
  const buyCandles = [
    ...
    // Form higher low sequence (10-candle window simulation)
  ...
  // Test 2: Price touches but RSI extreme
  console.log("\nTest 2: Price touches but RSI too high");

  const extremeRSI = 70;
  const result2 = detector.isPullbackComplete(buyCandles, engulfingLevel, "BUY", extremeRSI);

  if (result2) console.log("✗ Pullback detected (should reject - RSI extreme)");
  else console.log("✓ Correctly rejected (RSI too high)");
  ...
  const sellCandles = [
    ...
    // Form lower high sequence (10-candle window simulation)
    { timestamp: '2024-01-11T05:00:00Z', open: 1.0948, high: 1.0949, low: 1.0940, close: 1.0942 },
    { timestamp: '2024-01-11T06:00:00Z', open: 1.0942, high: 1.0945, low: 1.0930, close: 1.0932 },
    { timestamp: '2024-01-11T07:00:00Z', open: 1.0932, high: 1.0938, low: 1.0928, close: 1.0925 },
    { timestamp: '2024-01-11T08:00:00Z', open: 1.0925, high: 1.0930, low: 1.0920, close: 1.0922 },
    { timestamp: '2024-01-11T09:00:00Z', open: 1.0922, high: 1.0925, low: 1.0915, close: 1.0918 }
  ];
  ...
  console.log("\nTest 4: Price doesn't reach level");
  ...
  if (result4) console.log("✗ Pullback detected (should reject - no touch)");
  else console.log("✓ Correctly rejected (price never touched level)");
